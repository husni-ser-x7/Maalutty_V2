...
re-coded or modified by nijin-husni & KTB
to bring new ai
*/
...
Maalutty.addCommand({on: 'text', fromMe: wk, dontAddCommandList: true, deleteCommand: false}, (async (message, match) => {
...
Maalutty.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
...
Maalutty.addCommand({ pattern: 'vtalk$', desc: vtalk_dsc,dontAddCommandList: true, fromMe: wk }, (async (message, match) => {
...
Maalutty.addCommand({ pattern: 'maaluttyai ?(.*)', desc: fulleva_dsc, fromMe: true,dontAddCommandList: true, usage: '.maaluttyai on / off' }, (async (message, match) => {
    var maaluttyai_status = `${conf.TALKING_Maalutty}`
    if (match[1] == 'on') {
        if (maaluttyai_status == 'true') {
